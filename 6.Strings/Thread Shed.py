# Project Thread Shed
# You’ve recently been hired as a cashier at the local sewing hobby shop, Thread Shed. Some of
# your daily responsibilities involve tallying the number of sales during the day, calculating the total amount of
...
# sale is all recorded in this same string. Your task is to use your Python skills to iterate through this string and
