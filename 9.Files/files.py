...
# 10.Writing a CSV File We import the csv library, and then open a new CSV file in write-mode by passing the 'w'
...
# headers, so we call .writeheader() on the writer object.
