# 1.Introduction to Control Flow This is the control flow of your program. In Python, your script will execute from
# the top down, until there is nothing left to run. It is your job to include gateways, known as conditional
# statements, to tell the computer when it should execute certain blocks of code. If these conditions are met,
...
# This is an opinion and not a boolean expression, so you would set example_statement to "No" in the editor to the
# right. Okay, now it’s your turn: Statement one:Dogs are mammals.
statement_one = "Yes"
...
# 9.Boolean Operators: not The final boolean operator we will cover is not. This operator is straightforward: when
# applied to any boolean expression it reverses the boolean value. So if we have a True statement and apply a not
...
# 12.Review Great job! We covered a ton of material in this lesson and we’ve increased the number of tools in our
# Python toolkit by several-fold. Let’s review what we’ve learned this lesson:
